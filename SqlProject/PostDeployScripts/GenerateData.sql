...
begin
INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.041380 AS Decimal(8, 6)), CAST(-92.494070 AS Decimal(9, 6)), 1)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (CAST(35.985530 AS Decimal(8, 6)), CAST(-92.659560 AS Decimal(9, 6)), 2)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (Cast(34.247680 AS Decimal(8, 6)), CAST(-93.303010 AS Decimal(9, 6)), 3)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.500200 AS Decimal(8, 6)), CAST(-92.340530 AS Decimal(9, 6)), 4)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.047600 AS Decimal(8, 6)), CAST(-92.782460 AS Decimal(9, 6)), 5)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (CAST(36.130710 AS Decimal(8, 6)), CAST(-92.092050 AS Decimal(9, 6)), 7)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (CAST(36.000990 AS Decimal(8, 6)), CAST(-92.757490 AS Decimal(9, 6)), 8)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(35.629740 AS Decimal(8, 6)), CAST(-92.198310 AS Decimal(9, 6)), 9)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.529990 AS Decimal(8, 6)), CAST(-90.740430 AS Decimal(9, 6)), 10)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.817344 AS Decimal(8, 6)), CAST(-92.585746 AS Decimal(9, 6)), 11)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES ( CAST(36.304176 AS Decimal(8, 6)), CAST(-91.052600 AS Decimal(9, 6)), 12)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES ( CAST(34.963189 AS Decimal(8, 6)), CAST(-93.706020 AS Decimal(9, 6)), 13)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(35.773736 AS Decimal(8, 6)), CAST(-92.127767 AS Decimal(9, 6)), 14)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.297406 AS Decimal(8, 6)), CAST(-90.970228 AS Decimal(9, 6)), 15)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES ( CAST(37.853330 AS Decimal(8, 6)), CAST(-91.329189 AS Decimal(9, 6)), 16)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES ( CAST(35.058182 AS Decimal(8, 6)), CAST(-93.884800 AS Decimal(9, 6)), 17)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(33.753473 AS Decimal(8, 6)), CAST(-93.108778 AS Decimal(9, 6)), 18)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES ( CAST(35.534302 AS Decimal(8, 6)), CAST(-91.649323 AS Decimal(9, 6)), 19)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES ( CAST(36.858548 AS Decimal(8, 6)), CAST(-92.842531 AS Decimal(9, 6)), 20)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (CAST(36.428468 AS Decimal(8, 6)), CAST(-92.465052 AS Decimal(9, 6)), 21)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES ( CAST(35.656427 AS Decimal(8, 6)), CAST(-92.383587 AS Decimal(9, 6)), 22)

INSERT [dbo].[Locations] ( [Latitude], [Longitude], [HouseID]) VALUES (CAST(36.279544 AS Decimal(8, 6)), CAST(-90.437365 AS Decimal(9, 6)), 23)

INSERT [dbo].[Locations] ([Latitude], [Longitude], [HouseID]) VALUES (CAST(36.440819 AS Decimal(8, 6)), CAST(-92.816259 AS Decimal(9, 6)), 24)
